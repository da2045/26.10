...
//        std::cout << "nevirnui idex" << std::endl;
//        return;
//    }
//
//
...
//    ++cols; 
//
//    std::cout << "masuv pisla dodavania stovpza \n";
//    for (int i = 0; i < rows; ++i) {
//        for (int j = 0; j < cols; ++j) {
//            std::cout << arr[i][j] << " ";
//        }
...
//
//    int colIndex;
//    std::cout << "vedit index stovpza ";
//    std::cin >> colIndex;
//
//    removeColumn(arr, rows, cols, colIndex);
//    --cols; 
//
//    std::cout << "masuv pisla vudalena \n";
//    for (int i = 0; i < rows; ++i) {
//        for (int j = 0; j < cols; ++j) {
//            std::cout << arr[i][j] << " ";
//        }
...
//
//  
//    std::cout << "transponovana matrucia \n";
//    for (int i = 0; i < cols; ++i) {
